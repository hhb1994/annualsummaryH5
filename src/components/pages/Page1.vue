...
export default {
  ...
  methods: {
    ...
    formatStyle(item, index) {
      ...
      position: absolute;
      animation: bounceInDown 1s ${7 + index * 0.2}s forwards;
      `;
    },
    formatStyle2() {}
  },
...
.mapContainer {
  ...
  & .textContainer4 {
    ...
    & .img {
      ...
      & .img2 {
        ...
        top: 5px;
        right: 0px;
        animation: bounceInUp 1s $delayForP2 forwards;
      }
    }
  }
  & .textContainer5 {
  ...
  & .textContainer7 {
    ...
    & img {
      ...
      width: 100%;
      object-fit: cover;
      animation: zoomIn 1s infinite $delayForP3 forwards;
    }
  }
  & .textContainer8 {
    width: 127px;
